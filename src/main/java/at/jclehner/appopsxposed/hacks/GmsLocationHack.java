...
public class GmsLocationHack extends Hack {
    ...
    public GmsLocationHack(SharedPreferences prefs) {
        super(prefs);
    }
    ...
    protected void handleLoadAnyPackage(LoadPackageParam lpparam) {
        Set<String> classes = Util.getClassList(lpparam, "com.google.android.gms.location", true);
        if (classes == null || classes.isEmpty())
            return;

        StringBuilder sb = new StringBuilder(lpparam.packageName);

        if (classes.contains("com.google.android.gms.location.a"))
