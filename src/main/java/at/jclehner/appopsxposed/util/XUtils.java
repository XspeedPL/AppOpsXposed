...
public final class XUtils {
    public static ApplicationInfo getApplicationInfo(String packageName) {
        Class<?> atClazz = XposedHelpers.findClass("android.app.ActivityThread", null);
        Object pm = XposedHelpers.callStaticMethod(atClazz, "getPackageManager");

        try {
            ApplicationInfo ai = (ApplicationInfo) XposedHelpers.callMethod(pm,
    ...
    public static Unhook findAndHookMethodRecursive(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
        ...
        try {
            ...
            if (superClass == null) {
                ...
                Class<?> targetClass = ((XC_MethodHookRecursive) hook).getTargetClass();
