...
public class LG extends AOSP {
    ...
    public LG(SharedPreferences prefs) {
        super(prefs);
    }
                ...
                "addPreferencesFromResource", int.class, new XC_MethodHook() {
                    ...
                    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                        ...
                        for (int i = 0; i != ps.getPreferenceCount(); ++i) {
                            Intent intent = ps.getPreference(i).getIntent();
                        ...
                        Preference p = new Preference(pf.getActivity());
                        p.setTitle(Res.getModString(pf.getActivity(), R.string.app_ops_settings));
