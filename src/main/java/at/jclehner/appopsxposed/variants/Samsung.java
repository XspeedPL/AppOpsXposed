...
public class Samsung extends ApkVariant {
    private static final String GRID_SETTINGS = "com.android.settings.GridSettings";

    public Samsung(SharedPreferences prefs) {
        super(prefs);
    }
    ...
    public void handleLoadPackage(LoadPackageParam lpparam) throws Throwable {
        ...
        int manageAppsHeaderId = Res.getSettingsIdentifier("id/application_settings");
    ...
    private boolean hasGridSettings(LoadPackageParam lpparam) {
        try {
            XposedHelpers.findClass(GRID_SETTINGS, lpparam.classLoader);
            return true;
        } catch (Throwable t) {
            return false;
        }
